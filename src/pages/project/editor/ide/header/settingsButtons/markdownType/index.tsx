...
export const MarkdownTypes = () => {
  const prevActiveIndex = useSelector((state: StorageState) => state.ide.previousActiveSegmentIndex);
  const activeSegment = useSelector(useActiveSegment(prevActiveIndex >= 0 ? prevActiveIndex : 0));
