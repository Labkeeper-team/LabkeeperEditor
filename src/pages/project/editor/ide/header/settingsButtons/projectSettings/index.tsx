  ...
  return (
    <div className="project-settings-dropdown">
      ...
      >
        <Radio
          id="noRound"
          checked={activeProgram?.parameters.roundStrategy === 'noRound'}
        ...
        <Radio
          ...
          checked={
            activeProgram?.parameters.roundStrategy === 'firstMeaningDigit'
          }
        ...
        <Radio
          id="fixedDigits"
          checked={activeProgram?.parameters.roundStrategy === 'fixedDigits'}
