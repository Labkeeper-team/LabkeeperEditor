...
export const HistoryButtons = () => {
    ...
    useHotkeys(
        'ctrl+z',
        () => (!onPrevDisabled ? onPrevVersion() : undefined),
        { enableOnFormTags: true, enableOnContentEditable: true },
        [onPrevDisabled, activeIndex, historyIndex]
    );
    useHotkeys(
        'ctrl+y',
        () => (!onNextDisabled ? onNextVersion() : undefined),
        { enableOnFormTags: true, enableOnContentEditable: true },
        [onNextDisabled, activeIndex, historyIndex]
    );
