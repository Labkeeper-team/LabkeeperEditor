...
export const en: Translations = {
    ...
    interface_tour: {
        ...
        info_computed_segment: 'You can add a computed segment.\nIn it, you can create variables, execute functions, and evaluate expressions.\nThe computation results will appear in the segments on the right.',
        info_project_settings: 'Configure your project by selecting from the available options',
        info_run: 'This button starts the computation process.\nFormulas and functions from your segments on the left are computed and rendered on the right.',
        info_result: 'The execution and rendering result of your code.\nHere, you will find computation results, formulas, and graphs.',
        info_pdf: 'If you want to save or print the computation results, you can convert them to a PDF.',
        info_error: 'A list of errors found in your code during compilation.',
        info_add_markdown: 'You can add a segment with markdown text.\nVariable values can also be inserted using \${NAME}.',
        info_canvas: 'This is where the segments that make up your program are located.',
    },
    ...
    compile_error: {
        ...
        [CompileError.NOT_ENOUGH_WORKERS]: 'Not enough computational power on servers to compile',
        [CompileError.INCORRECT_ARGUMENTS_COUNT]: 'Incorrect number of arguments in the function ',
        [CompileError.VARIABLE_INSERT_ERROR]: 'Error inserting variable into md text',
        [CompileError.FILE_USAGE_NOT_ALLOWED]: 'You may not use files unauthenticated',
        [CompileError.TOO_MUCH_FILES]: 'Too much files for one project',
        [CompileError.INCORRECT_ARGUMENT_SIZE]: 'Incorrect array argument length in function',
        [CompileError.INCORRECT_ARGUMENT]: 'Incorrect argument size in function',
        [CompileError.FUNCTION_HAS_NO_RETURN_VALUE]: 'No return value in function',
