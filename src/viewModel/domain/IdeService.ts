...
import { isImageFilePath } from '../../view/pages/project/fileManager/svarFileTreeAdapter.ts';
...
export class IdeService {
    ...
    calculateFilesToDelete = (program: Program) => {
        if (
            ...
            this.repository.projectViewModelRepository.mode() === 'markdown' &&
