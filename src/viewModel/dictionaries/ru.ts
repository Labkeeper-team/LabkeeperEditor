...
export const ru: Translations = {
    ...
    agent_chat: {
        ...
        stop: {
            ...
            QuotaExceeded:
                'Агент упёрся в ограничение проекта: файл вышел больше допустимого размера или сегментов стало больше допустимого. То, что он успел сделать до этого, уже в проекте',
