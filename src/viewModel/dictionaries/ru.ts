...
export const ru: Translations = {
    ...
    agent_chat: {
        ...
        guest_login_hint:
            'Вы не вошли в аккаунт. Под аккаунтом у агента свой баланс токенов и своя история',
        guest_login_hint_limit:
            'Вы не вошли в аккаунт, поэтому у агента действует лимит для незарегистрированных. Вход его снимает: запросы идут из вашего баланса токенов, история и правки остаются в проекте. Число итераций, размер контекста и десять минут на прогон ограничены и после входа',
        guest_login_action: 'Войти',
        ...
        send_errors: 'Отправить агенту',
        errors_prompt: 'Исправь ошибки компиляции:',
        errors_prompt_busy:
            'В поле агента уже есть текст. Отправьте или сотрите его и нажмите кнопку ещё раз',
        ...
        change: {
            ...
            file: 'Файл {file}',
            other: 'Место без имени',
            more: 'и другие места проекта',
        },
        stop: {
            ContextOverflow:
            ...
            UnauthorizedLimitExceeded: 'Лимит без регистрации исчерпан',
            PaymentRequired:
            ...
            PromptTooLong:
                'Запрос слишком длинный. Сократите текст и отправьте ещё раз',
            QuotaExceeded:
                'Агент остановлен: он попытался создать файл больше допустимого размера или добавить больше сегментов, чем разрешено. То, что он успел сделать до этого, уже в проекте',
            ...
            sync_failed:
                'Не удалось сверить проект с сервером после прошлого прогона. Запуск отменён, чтобы не затереть правку агента: обновите страницу и попробуйте ещё раз',
            aborted:
                'Прогон прерван. Агент успел поправить эти места, и его правки остались в проекте:',
            aborted_nothing: 'Прогон прерван. Изменить агент ничего не успел',
            aborted_guest:
                'Прогон прерван. Без входа в аккаунт правки агента приходят только в конце прогона, поэтому результат потерян целиком и проект остался прежним',
            aborted_unsynced:
    ...
    hunks: {
        ...
        errors: {
            accept_failed:
                'Не все изменения удалось принять, попробуйте ещё раз',
            revert_failed:
                'Не все изменения удалось отклонить, попробуйте ещё раз',
        },
    },
