...
export const ru: Translations = {
    ...
    quota_help: {
        '1': 'Напишите нам в поддержку, если вам не хватает ресурсов.',
        '2': 'Напишите нам в поддержку, если вам не хватает ресурсов.',
        '3': 'Напишите нам в поддержку, если вам не хватает ресурсов.',
        '4': 'Напишите нам в поддержку, если вам не хватает ресурсов.',
        '5': 'Напишите нам в поддержку, если вам не хватает ресурсов.',
        '6': 'Возможно, вам стоит скрыть часть вычислений, это ускорит работу программы, это можно сделать, если нажать на три точки в панели сегмента.',
    },
