...
test('add-new-file-via-CtrV-test_3', () => {
    ...
    const files: LabkeeperFile[] = [
        ...
        {
            autogenerated: true,
            fileName: `file_seg5_${suffix}(1).png`,
            url: '25',
        },
        {
            autogenerated: true,
            fileName: `file_seg5_${suffix}(2).png`,
            url: '25',
        },
        {
            autogenerated: true,
            fileName: `file_seg5_${suffix}(3).png`,
            url: '25',
        },
        {
            autogenerated: true,
            fileName: `file_seg5_${suffix}(4).png`,
            url: '25',
        },
    ];
    repository.projectViewModelRepository.setFiles(files);
    ...
    expect(result).toBe(`file_seg5_${suffix}(5).png`);
});
...
test('add-new-file-via-CtrV-test_4', () => {
    ...
    const files: LabkeeperFile[] = [
        ...
        {
            autogenerated: true,
            fileName: `file_seg5_${suffix}(7).png`,
            url: '25',
        },
        {
            autogenerated: true,
    ...
    expect(result).toBe(`file_seg5_${suffix}(2).png`);
});
...
test('add_new-file-without-ext-from-add-file', () => {
    const { fileService } = mockContext();
    const segment_id = null;
    expect(fileService.calculateNumberFile(segment_id, 'abc')).toBe(
        `abc_${suffix}`
    );
});
...
test('add-file-with-exist-name-from-add-file-with-suffixes-and-without-ext', () => {
    ...
    repository.projectViewModelRepository.setFiles(files);
    expect(fileService.calculateNumberFile(null, 'abc')).toBe(
        `abc_${suffix}(1)`
    );
});
...
test('add-file-with-exist-name-from-add-file-without-suffix', () => {
    ...
    repository.projectViewModelRepository.setFiles(files);
    expect(fileService.calculateNumberFile(null, 'a.png')).toBe(
        `a_${suffix}.png`
    );
});
