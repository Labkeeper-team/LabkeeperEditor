...
test('ESC-test', async ({ page }) => {
    ...
    await page.route(/\/api\/v2\/public\/project\/(default|1\/get)/, async route => {
        await route.fulfill({
            status: 200,
...
test('Search-test', async ({ page }) => {
    ...
    await page.getByRole('textbox', {name: /Введите текст для поиска/i}).click();
    await page.getByRole('textbox', {name: /Введите текст для поиска/i}).pressSequentially('aa');
...
|      |      |      |      |   |   |   |   |   |   |   |   |   | gggg |
    ...
    await expect(page).toHaveScreenshot('md2pdf.png');
})
